...
export default function TermsPage() {
  return (
    <LegalCenterCard
      title="Terms of Service"
      description="These terms govern your use of Nyvon, including acceptable behavior, content rules, and limitations of liability."
    >
      <div className="space-y-6">
        <section>
          <h2 className="font-semibold text-white">Acceptable use</h2>
          <p className="mt-2 text-white/68">
            Use Nyvon respectfully and lawfully. Do not use the app for
        ...
        <section>
          ...
          <p className="mt-2 text-white/68">
            Nyvon helps people discover and create plans, but users are
        ...
        <section>
          ...
          <p className="mt-2 text-white/68">
            Nyvon V1 is an early MVP. Features, availability, moderation tools,
